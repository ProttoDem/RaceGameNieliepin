...
{
    public class CameraDefault : CameraPos
    {
        ...
        public float CarY;
        public float CarZ;
        public CameraDefault(Transform cameraTransform, Transform carTransform) : base(cameraTransform, carTransform)
        {
        }
        ...
        {
            _cameraTransform.Translate(0f, 0f, 0f);
        }
